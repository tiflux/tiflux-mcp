...
const schema = {
  ...
  description: 'Listar chats na caixa de entrada (chats não assumidos) com filtros opcionais de departamento, cliente, origem e paginação. O campo assumed_at vem da coluna crua da API e é sempre nulo no inbox (chats ainda não assumidos); pode divergir do get_chat em chats legados.',
  inputSchema: {
    type: 'object',
    properties: {
